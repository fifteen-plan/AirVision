...
DETECT_CLASS = (Detect,  DetectAux, )
V10_DETECT_CLASS = (v10Detect, v10Detect_TSAH, )
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            OREPA, OREPA_LargeConv, RepVGGBlock_OREPA, SPDConv,  RFAConv, RFCAConv, RFCBAMConv, SimpleStem, VisionClueMerge, VSSBlock_YOLO, XSSBlock
        }:
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in {
                     BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB,  XSSBlock
                    }:
            ...
            if m in SEGMENT_CLASS:
                ...
                #     args[3] = make_divisible(min(args[3], max_channels) * width, 8)
            if m in (Detect_TSAH, v10Detect_TSAH):
            ...
            c2 = m.channel
                   ...
                   FocusedLinearAttention, LocalWindowAttention, CAA, ELA, AFGCAttention,CARAFE}:
            c2 = ch[f]
            args = [c2, *args]
            # print(args)
